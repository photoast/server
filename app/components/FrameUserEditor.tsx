          ...
          >
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 15l4-4a2 2 0 012.828 0L14 14m0 0l2-2a2 2 0 012.828 0L20 13m-6 1l-1.5 1.5M14 10h.01" />
              </svg>
              {t('picker.album')}
            </button>
